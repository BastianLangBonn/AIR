  ...
  public SalesmanNode perform() throws IOException {
    ...
    while (temperature > 0) {
      ...
      if (difference > 0) {
        ...
        // System.out.println(String.format("Difference: %f", difference));
        // use 1000000 as approximation for Boltzmann-constant
        double probability = Math.exp(difference / temperature * 1000000);
        // System.out.println(String.format("Temperature: %d", temperature));
        // if (probability > 0.5) {
        // System.out.println(String.format("Probability: %f", probability));
        // }
        if (diceThrow <= probability) {
          // System.out.println("Going uphill again");
          current = next;
          uphills++;
        }
      ...
      // System.out.println(String.format("remaining time: %d", temperature));
      iterations++;
    }
